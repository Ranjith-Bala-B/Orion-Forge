...
export const AuthScreen: React.FC<AuthScreenProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-[85vh] pt-28 pb-20 bg-[#FAFBFC] text-slate-900 relative overflow-hidden flex items-center justify-end pr-24 md:pr-36 lg:pr-52">
      ...
      <div className="absolute top-1/4 left-1/3 h-96 w-96 rounded-full bg-[#5B3DF5]/30 blur-3xl opacity-60 animate-pulse pointer-events-none" />
      <div className="absolute bottom-10 right-1/4 h-80 w-80 rounded-full bg-[#38BDF8]/20 blur-3xl opacity-50 pointer-events-none" />
      ...
      >
        ...
        <motion.div
          ...
          transition={{ duration: 0.4 }}
          className="rounded-3xl bg-white backdrop-blur-2xl border border-slate-200 p-8 shadow-[0_20px_50px_rgba(91,61,245,0.1)]"
        >
          {/* Header */}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {authStatus === 'idle' && (
              <>
                ...
                <button
                  type="submit"
                  className="group w-full flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-[#5B3DF5] to-[#38BDF8] py-3.5 text-sm font-bold text-white shadow-[0_4px_25px_rgba(91,61,245,0.4)] hover:shadow-[0_6px_30px_rgba(56,189,248,0.6)] active:scale-98 transition-all"
                >
